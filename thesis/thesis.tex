...
While the $x_2$ term goes to infinity the $x_1$ term goes to $C$. The $C$ constant is the for the continuation of the solution so the smaller $x_i$ will always go to $C$. Here is a graph of the values of $x_1$ and $x_2$ over time 
