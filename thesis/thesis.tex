...
The Hamiltonian formalism is a fundamental framework that offers a powerful method for analyzing dynamical systems. The state of the system is described by a set of canonical coordinates \cite{Olver_1968}
\begin{equation}
...
\end{center}
%
The CH equation also has a canonical Hamiltonian structure with the Hamiltonian
\begin{equation}
	H = \frac{1}{2}\sum_{ij} m_i m_j e^{-|x_i-x_j|}.
\end{equation}
%
The Hunter Saxton equation also has a similar canonical Hamiltonian structure with the Hamiltonian \cite{Beals_2001}
\begin{equation}
	H = \frac{1}{2}\sum_{ij} m_i m_j |x_i-x_j|.
\end{equation}
%
We wanted to find a Hamiltonian structure for the HF Novikov peakon ODEs but it was harder than expected. The search for a Hamiltonian structure was done by trying to start from the Novikov Hamiltonian structure and try to modify it to fit the HF Novikov peakon ODEs. If the search is continued in the future, a more structured approach should be taken.
...
\begin{proof}
	...
	\begin{aligned}
		...
		&+ \sum_{i,j,k,l} m_i m_j m_k m_l s(i,j) g'(i,j) (g(i,k) g(i,l) - g(j,k) g(j,l)).
	\end{aligned}
	\end{equation}
...
\begin{subequations}
  ...
  \end{equation}
\end{subequations}
Letting $\epsilon \rightarrow 0$ we get rid of the 1 in the $(1,3)$ entry in $U$ matrix of the Lax pair, while the $V$ matrix is left unchanged. This new lax pair satisfies the zero curvature condition for the HF--Novikov equation \eqref{eq:HF-Novikov}. We can simplify the system even further with the following substitutions
\begin{equation}
\left\{ \begin{aligned}
	&\varphi_1 = &\psi_1, \\
	&\varphi_2 = &z\psi_2, \\
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.44\textwidth}
        ...
        \caption{$m_i$}
    \end{subfigure}
    \caption{At $t=0$: $m_1 = 1$, $x_1 = 0$, $m_1 = 2$, $x_2 = 1$, $m_3 = 3$, $x_3 = 2$}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.44\textwidth}
        ...
        \caption{$m_i$}
    \end{subfigure}
    \caption{At $t=0$: $m_1 = -10$, $x_1 = 0$, $m_1 = 10$, $x_2 = 0.2$, $m_3 = 2$, $x_3 = 5$}
\end{figure}
%
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.44\textwidth}
        ...
        \caption{u(x,t)}
    \end{subfigure}
    \caption{At $t=0$: $m_1 = 1$, $x_1 = 0$, $m_1 = 2$, $x_2 = 3$}
    \label{fig:u2N}
\end{figure}
\begin{figure}[H]
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.44\textwidth}
        ...
        \caption{u(x,t)}
    \end{subfigure}
    \caption{At $t=0$: $m_1 = 2, x_1 = 1, m_1 = 0.5, x_2 = 3, m_3 = 5, x_3 = 4, m_4 = 2, x_4 = 8.5$}
\end{figure}
\begin{figure}[H]
	\begin{subfigure}[t]{0.3\textwidth}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.3\textwidth}
        ...
        \caption{$m_i$}
    \end{subfigure}
    \caption{$m_1 = 1$, $x_1 = 0$, $m_1 = 2$, $x_2 = 2$, $m_3 = -2$, $x_3 = 4$}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Barycenter of HF--Novikov with $m_1 = 1$, $x_1 = 0$, $m_1 = 2$, $x_2 = 1$, $m_3 = 3$, $x_3 = 2$, $x_4 = 4$, $x_4 = 3$ at $t = 0$}
	\label{fig:minU}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Barycenter of HS with $m_1 = 1$, $x_1 = 0$, $m_1 = 2$, $x_2 = 1$, $m_3 = 3$, $x_3 = 2$, $x_4 = 4$, $x_4 = 3$ at $t=0$}
\end{figure}
\begin{figure}[H]
	\begin{subfigure}{0.44\textwidth}
    ...
    \end{subfigure}
    \caption{Barycenter of DB with $m_1 = 1$, $x_1 = 0$, $m_1 = 2$, $x_2 = 1$, $m_3 = 3$, $x_3 = 2$, $x_4 = 4$, $x_4 = 3$ at $t=0$}
\end{figure}
